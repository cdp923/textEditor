...
g++ wWinMain.cpp WindowProc.cpp textEditorGlobals.cpp textMetrics.cpp updateCaretAndScroll.cpp fileOperations.cpp undoStack.cpp characterCase.cpp isModified.cpp cursorControls.cpp textEditor.res -o textEditor.exe -mwindows -municode -lcomdlg32
textEditor.exe
*/
